<template>
    <div class="update-profile-page w-690">
        <ul class="nav nav-tabs my-4">
            ...
            <li><a href="#" :class="generateActiveClass('column')" @click.prevent="switchTab('column')">
                更新专栏信息
            </a></li>
        </ul>
...
export default defineComponent({
    ...
    setup() {
        ...
        const userStore = computed(() => {return store.state.user;});
        ...
        return {
            titleRules, contentRules, nameValue, descValue, onFileUploaded, commonUploadCheck, onFormSubmit,
            generateActiveClass, switchTab, uploadedData
        };
    }
});
</script>
